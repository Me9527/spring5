...
public class CustomSecurityMethodMetadataSource extends AbstractFallbackMethodSecurityMetadataSource
	...
	public void afterPropertiesSet() throws java.lang.Exception {
    	List<SecurityMetadata> secServices = securityMetadataDao.loadServicePermission();
    	logger.debug("secUrls = " + secServices);
    	Map<String, SecurityConfig> attrs = new HashMap<String, SecurityConfig>();
    	for(SecurityMetadata ss: secServices){
    	...
    	for(SecurityMetadata ss: secServices){
    		List<ConfigAttribute> c = new ArrayList<ConfigAttribute>();
			c.add(attrs.get(ss.getAttribute()));
			addSecureMethod(ss.getResource(), c);
    	}
    	
//    	SecurityConfig teller = new SecurityConfig(rolePrefix + "serviceLayPermission");
